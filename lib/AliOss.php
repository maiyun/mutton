...
namespace M\Lib {
    ...
    require LIB_PATH.'AliOss/Core/MimeTypes.php';
    require LIB_PATH.'AliOss/Core/OssException.php';
    require LIB_PATH.'AliOss/Http/RequestCore.php';
    require LIB_PATH.'AliOss/Http/ResponseCore.php';
    require LIB_PATH.'AliOss/Result/Result.php';
    require LIB_PATH.'AliOss/Result/PutSetDeleteResult.php';
    require LIB_PATH.'AliOss/Result/ExistResult.php';

    require ETC_PATH.'ali-oss.php';
