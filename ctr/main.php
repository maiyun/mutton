    ...
    class main extends Ctr {
		...
		public function main() {
			...
			$echo = [
                ...
                '<br><br>URI: ' . URI . '.',
                '<br>HTTPS: ' . ($this->isHttps() ? 'true' : 'false') . '.',
                ...
                '<br><br><a href="'.HTTP_PATH.'main/auto">View "main/auto"</a>',
...
<b>getSql():</b> $s;</pre>";
        ...
        public function net() {
            ...
            try {
                ...
                $rtn[] = "Net::get('https://cdn.jsdelivr.net/npm/deskrt/package.json');\n\n".$result;
            } catch (\Exception $e) {
                $rtn[] = $e->getMessage();
            }

            return implode('', $rtn) . '</pre>' . $this->_getEnd();
        }
